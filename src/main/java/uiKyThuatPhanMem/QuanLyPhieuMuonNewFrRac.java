 ...
 * @author ACER NITRO 5
 */
public class QuanLyPhieuMuonNewFrRac extends javax.swing.JPanel {
...
private DefaultTableModel tableModel2;
     ...
     */
    public QuanLyPhieuMuonNewFrRac() {
        initComponents();
        initTable();
        loadDataToTable();
        initTable3();
    ...
    private void initTable3() {
        ...
        tableModel2.setColumnIdentifiers(new String[]{"Mã" ,"Mã Sinh Viên", "Mã Sách", "Số Lượng"});
        ...
        try {
            ...
            for (PhieuMuon it : list) {
                tableModel2.addRow(new Object[]{
                     it.getMa(),it.getMaSV(), it.getMaSach(), it.getSoLuong(),
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"LK03", "SV02", "Lời Chia Tay Đẹp Nhất Thế Gian"},
                {"LK03", "Sv03", "SHERLOCK hOLMES"},
                {"LK03", "SV04", "CONAN"},
                {"LK02", "SV01", "Mắt Biếc"}
            },
            new String [] {
                "Mã Thư Viên Liên Kết", "Mã Người Đọc", "Sách"
            }
        ));
        jScrollPane2.setViewportView(jTable1);

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel10.setText("Những Sinh Viên Đang Chờ Mượn Sách Ở Thư Viện Ngoài:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jLabel8)
                                .addComponent(txtSreach, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (check() == true) {
            PhieuMuon sv = new PhieuMuon();
            sv.setMa(Integer.parseInt(txtMaSachDaThem.getText()));
            sv.setMaPhieuMuon(txtMaPhieuMuon.getText());
            sv.setMaSV(txtMaSV.getText());
            sv.setMaSach(txtMaSach.getText());
            sv.setSoLuong(Integer.parseInt(txtSoLuong.getText()));
...
//        loadDataSach();
    ...
    private void tblPhieuMuon2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPhieuMuon2MouseClicked
        ...
        try {
            ...
            if (row >= 0) {
                String id = (String.valueOf(tblPhieuMuon2.getValueAt(row, 0))) ;
                PhieuMuonDAO dao = new PhieuMuonDAO();
