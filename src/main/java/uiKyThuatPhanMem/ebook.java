...
public class ebook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_inbox1.setText("Sách Đã Thuê");
        ...
        jLabel5.setText("Lời Chia Tay Đẹp Nhất Thế Gian");
        ...
        jTextArea1.setText("Chính hình ảnh người mẹ bé nhỏ hằng ngày đấu tranh với thần chết đã làm họ nhận ra sự bạc bẽo của mình với người mẹ đáng thương.\n\nThực ra, chuyện Lời Chia Tay Đẹp Nhất Thế Gian không có quá nhiều chi tiết kịch tính. Khi phát hiện căn bệnh, mọi người trong gia đình dường như đã chấp nhận cái kết buồn rồi sẽ xảy đến một ngày. Người mẹ mắc bệnh ung thư lại là người cuối cùng biết được tình trạng sức khỏe của mình. Cho đến những ngày cuối cùng trong cuộc đời, bà vẫn lo lắng cho mọi người trong nhà bà vẫn làm suốt mấy chục năm nay.");
        ...
        jLabel14.setText("Nhà văn Noh Hee Kyung");

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/sach-loi-chia-tay-dep-nhat-the-gian3.png"))); // NOI18N
        ...
        jLabel2.setText("Nhà Văn: Dale Carnegie");

        jLabel7.setText("Đăc Nhân Tâm");
        ...
        jLabel11.setText("Nhà Xuất Bản: Nhà Xuất Bản Thanh Niên ");
        ...
        jLabel3.setText("Nguyễn Nhật Ánh");

        jLabel8.setText("Mắc Biếc");
        ...
        jLabel12.setText("Nhà Xuất Bản: Nhà Xuất Bản Thanh Niên ");
        ...
        jLabel4.setText("Nhà Văn: Jeffrey Archer");

        jLabel9.setText("Hai Số Phận");
        ...
        jLabel13.setText("Nhà Xuất Bản: Nhà Xuất Bản Thanh Niên ");
        ...
        jLabel1.setText("Nhà văn Noh Hee Kyung");

        jLabel6.setText("Lời Chia Tay Đẹp Nhất Thế Gian");

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(51, 51, 51));
        jLabel10.setText("Nhà Xuất Bản: Nhà Xuất Bản Thanh Niên ");
